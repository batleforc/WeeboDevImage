...
LABEL org.opencontainers.image.url="https://github.com/batleforc/WeeboDevImage/che-base-slim"
...
## Install zip, gnupg2, vim, stow, net-tools, libnode-dev, less, htop, pkg-config
## Install Gnupg aliases + Starship Shell Prompt + Mise
RUN apt-get update && \
